...
import { Sparkles, Mail, Lock, User, Eye, EyeOff, Star } from 'lucide-react';
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Create your account and unlock the mysteries of the universe
          </p>
        </div>
        ...
        <CosmicCard className="p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Submit Button */}
            <Button type="submit" variant="cosmic" className="w-full" disabled={isLoading || formData.password !== formData.confirmPassword}>
              <Star className="mr-2 h-4 w-4" />
              {isLoading ? 'Creating Account...' : 'Join the Cosmic Community'}
            </Button>
          </form>
        ...
        <CosmicCard className="mt-6 p-6">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-center">
              <Star className="h-4 w-4 text-secondary mr-3 flex-shrink-0" />
              <span>3 free oracle consultations to start your journey</span>
            </div>
            <div className="flex items-center">
              <Sparkles className="h-4 w-4 text-accent mr-3 flex-shrink-0" />
              <span>Personalized cosmic insights and guidance</span>
            </div>
            <div className="flex items-center">
              <Star className="h-4 w-4 text-primary mr-3 flex-shrink-0" />
              <span>Access to your fortune history and analytics</span>
            </div>
          </div>
        </CosmicCard>
      </div>
