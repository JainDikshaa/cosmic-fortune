...
serve(async (req) => {
  ...
  try {
    ...
    // Define plan prices
    const planPrices = {
      'cosmic-seeker': { amount: 999, name: 'Cosmic Seeker' }, // $9.99
      'starlight-mystic': { amount: 1999, name: 'Starlight Mystic' }, // $19.99
      'celestial-oracle': { amount: 3999, name: 'Celestial Oracle' } // $39.99
    };
